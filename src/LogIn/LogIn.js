...
export default class LogIn extends React.Component {
  ...
  onSubmit= (e)=>{
   ...
   render() {
    return (
    <div className="Login">
    <h1 className="pageLOGIN">Connectez-vous pour accéder à votre compte</h1>
       <div className="email"> 
        ...
        <div className="Connecter">
            <button className="connecter" onClick={e=>this.onSubmit(e)} type="primary" > Se connecter</button>
        </div>
